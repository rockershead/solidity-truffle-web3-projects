...
var number_of_LTOK=10000
await contract.methods.createLease("John","Blk 508 Woodlands St 11 #06-76",1617199800,BigInt(Number(number_of_LTOK)*Math.pow(10,18)),"f7d09c35-9c8a-4190-a373-ba8f1920f948").send({
from:addresses[2],gas:3000000
})


//console.log(contract.events.leaseCreated())
